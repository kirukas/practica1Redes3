...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(120, 40, 181, 32))
        self.lineEdit.setObjectName("lineEdit")

        self.lineEdit_2 = QtWidgets.QLineEdit(self.Tab2)
        self.lineEdit_2.setGeometry(QtCore.QRect(120, 80, 181, 32))
        self.lineEdit_2.setObjectName("lineEdit_2")

        self.lineEdit_3 = QtWidgets.QLineEdit(self.Tab2)
        self.lineEdit_3.setGeometry(QtCore.QRect(120, 120, 181, 32))
        self.lineEdit_3.setObjectName("lineEdit_3")

        self.lineEdit_4 = QtWidgets.QLineEdit(self.Tab2)
        self.lineEdit_4.setGeometry(QtCore.QRect(120, 160, 181, 32))
        self.lineEdit_4.setObjectName("lineEdit_4")

        self.pushButton = QtWidgets.QPushButton(self.Tab2)
        self.pushButton.setGeometry(QtCore.QRect(210, 220, 88, 34))
        ...
        self.lineEdit_5.setGeometry(QtCore.QRect(120, 50, 181, 32))
        self.lineEdit_5.setObjectName("lineEdit_5")

        self.pushButton_2 = QtWidgets.QPushButton(self.tab)
        self.pushButton_2.setGeometry(QtCore.QRect(210, 110, 88, 34))
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(30, 70, 281, 32))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_2.setText(_translate("Dialog", "Eliminar"))
        ...
        self.comboBox_2.setItemText(0, _translate("Dialog", "Linux 1"))
        self.comboBox_2.setItemText(1, _translate("Dialog", "Windows"))
        ...
        puerto = 161
        community = 'SNMPcom'
        self.monitorear = Monitorear('Linux 1', '192.168.1.66', puerto, community, listaOID)
