...
class Dialog(QDialog):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Agregar Agente")


    def createFormGroupBox(self):
        self.formGroupBox = QGroupBox("Agente")


        layout = QFormLayout()
        layout.addRow(QLabel("Hostname:"), QLineEdit())
        layout.addRow(QLabel("Version SNMP:"), QLineEdit())
        layout.addRow(QLabel("Puerto:"), QLineEdit())
        layout.addRow(QLabel("Comunidad:"), QLineEdit())
